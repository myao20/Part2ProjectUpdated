...
def create_data_loaders(csv_name):
    ...
    # data loaders
    train_loader = DataLoader(train_data, batch_size=config["dataloader"]["batch_size"], shuffle=True)
    val_loader = DataLoader(val_data, batch_size=config["dataloader"]["batch_size"], shuffle=False)
    test_loader = DataLoader(test_data, batch_size=config["dataloader"]["batch_size"], shuffle=False)
